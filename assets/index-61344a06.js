...
const w=t.compile(f),i=s.map(e=>w(e)).join("");console.log(" markup:",i);r.innerHTML=i;const m=[{name:"Студія",href:"./index.html",active:!0},{name:"Портфоліо",href:"./portfolio.html",active:!1},{name:"Контакти",href:"./contacts.html",active:!1}],b={links:m},h=`{{#each links}}
