...
const U=r.compile(L),f=o.map(e=>U(e)).join("");console.log(" markup:",f);y.innerHTML=f;console.log('%c Додаємо/Редагуємо/Видаляємо розробників в секції "Наша команда" ',"color: white; background-color: #D33F49");//! 1.1 Взяти з localStorage дані які вже у нас є! 
...
document.querySelector(".our-developers-list");const R=document.querySelector(".our-developers__button"),m=document.querySelector(".form-add-edit-developer__title"),k=document.querySelector("[data-modal-add-edit-developer]"),p=document.querySelector(".modal-add-edit-developer__button-delete"),c=document.querySelector(".form-add-edit-developer"),D=document.getElementById("button-cancel"),_=document.querySelectorAll("#img-developer"),i=document.querySelector(".form-add-edit-developer__button-submit"),d=document.querySelector(".form-add-edit-developer__img");console.log("imgFormDeveloper:",d);const g=document.querySelector(".form-add-edit-developer__input-developer-name"),u=document.querySelector(".form-add-edit-developer__input-developer-position");//! 2.2 Змінні для поточної роботи
//! 3 надати слухачів подій
R.addEventListener("click",S);c.addEventListener("submit",M);D.addEventListener("click",I);_.forEach(e=>{e.addEventListener("click",q),console.log("click on:",e)});//! 4 блок функцій 
//! Додає розробника
function S(){console.log("додаємо нового розробника");//! 4.1.1 заміна контенту заголовка модального вікна, приховуємо зайві елементи
m.textContent="Додати розробника",i.textContent="Додати",p.style.display="none";//! 4.1.2 відкриття модального вікна з формою для збирання даних
a()}//! редагує розробника 
function q(e){console.log("Вікно редагування");//! 4.1.1 заміна контенту заголовка модального вікна, відкриваємо необхідні елементи
m.textContent="Редагування розробника",i.textContent="Редагувати",p.style.display="block";//! при натисканні на розробника треба, щоб підставлялось його зображення
