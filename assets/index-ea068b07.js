import{H as u}from"./social-list-4cd0fcf0.js";const h=[{title:"УВАГА ДО ДЕТАЛЕЙ",text:"Ідейні міркування, і навіть початок повсякденної роботи з формування позиції."},{title:"ПУНКТУАЛЬНІСТЬ",text:"Завдання організації, особливо рамки і місце навчання кадрів тягне у себе."},{title:"ПЛАНУВАННЯ",text:"Так само консультація з широким активом значною мірою зумовлює."},{title:"СУЧАСНІ ТЕХНОЛОГІЇ",text:"Значимість цих проблем настільки очевидна, що реалізація планових завдань."}],v=` <li class="our-pluses-list__item">
    <h3 class="our-pluses-list__title">{{title}}</h3>
    <p class="our-pluses-list__text">{{text}}</p>
  </li>`,x=document.querySelector(".our-pluses-list"),L=u.compile(v),k=h.map(e=>L(e)).join("");x.innerHTML=k;(()=>{const e={openModalBtn:document.querySelector("[data-modal-open]"),closeModalBtn:document.querySelector("[data-modal-close]"),modal:document.querySelector("[data-modal]")};e.openModalBtn.addEventListener("click",c),e.closeModalBtn.addEventListener("click",c);function c(){e.modal.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll")}})();const d="/webstudio-vite-js/assets/igor-desktop-1x-b138e391.jpg",r="/webstudio-vite-js/assets/igor-desktop-2x-18e23e2e.jpg",f="/webstudio-vite-js/assets/igor-desktop-3x-f0641e09.jpg",g="/webstudio-vite-js/assets/igor-tablet-1x-a1f96800.jpg",b="/webstudio-vite-js/assets/igor-tablet-2x-5bd351b1.jpg",w="/webstudio-vite-js/assets/igor-tablet-3x-4c28ed9e.jpg",t="/webstudio-vite-js/assets/igor-mobile-1x-9e045f9a.jpg",m="/webstudio-vite-js/assets/igor-mobile-2x-dedb5f8b.jpg",p="/webstudio-vite-js/assets/igor-mobile-3x-e67f5e2c.jpg",o="/webstudio-vite-js/assets/symboldefs-fedcc540.svg#instagram",i="/webstudio-vite-js/assets/symboldefs-fedcc540.svg#twitter",l="/webstudio-vite-js/assets/symboldefs-fedcc540.svg#facebook",a="/webstudio-vite-js/assets/symboldefs-fedcc540.svg#linkedin";console.error('Рендеримо список розробників в секції "Наша команда"');//! Знаходимо елемент в якому рендерим список розробників
...
U.innerHTML=j;const _=[{name:"Студія",href:"./index.html",active:!0},{name:"Портфоліо",href:"./portfolio.html",active:!1},{name:"Контакти",href:"./contacts.html",active:!1}],$={links:_},D=`{{#each links}}
