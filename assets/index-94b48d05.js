...
const h=n.compile(w),c=o.map(e=>h(e)).join("");console.log(" markup:",c);v.innerHTML=c;console.log('%c Додаємо/Редагуємо/Видаляємо розробників в секції "Наша команда" ',"color: white; background-color: #D33F49");//! 1.1 Взяти з localStorage дані які вже у нас є! 
...
document.querySelector(".our-developers-list");const j=document.querySelector(".our-developers__button"),d=document.querySelector(".form-add-edit-developer__title"),x=document.querySelector("[data-modal-add-edit-developer]"),r=document.querySelector(".modal-add-edit-developer__button-delete"),i=document.querySelector(".form-add-edit-developer"),L=document.getElementById("button-cancel"),U=document.querySelectorAll("#img-developer"),f=document.querySelector(".form-add-edit-developer__button-submit"),a=document.querySelector(".form-add-edit-developer__img");console.log("imgFormDeveloper:",a);//! 2.2 Змінні для поточної роботи
