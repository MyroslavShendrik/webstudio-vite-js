...
const h=a.compile(w),n=o.map(e=>h(e)).join("");console.log(" markup:",n);v.innerHTML=n;console.log('%c Додаємо/Редагуємо/Видаляємо розробників в секції "Наша команда" ',"color: white; background-color: #D33F49");//! 1.1 Взяти з localStorage дані які вже у нас є! 
...
document.querySelector(".our-developers-list");const j=document.querySelector(".our-developers__button"),c=document.querySelector(".form-add-edit-developer__title"),x=document.querySelector("[data-modal-add-edit-developer]"),d=document.querySelector(".modal-add-edit-developer__button-delete"),i=document.querySelector(".form-add-edit-developer"),L=document.getElementById("button-cancel"),U=document.querySelectorAll("#img-developer"),r=document.querySelector(".form-add-edit-developer__button-submit"),f=document.querySelector(".form-add-edit-developer__img");console.log("imgFormDeveloper:",f);//! 2.2 Змінні для поточної роботи
//! 3 надати слухачів подій
j.addEventListener("click",R);i.addEventListener("submit",_);L.addEventListener("click",k);U.forEach(e=>{e.addEventListener("click",y),console.log("click on:",e)});//! 4 блок функцій 
...
c.textContent="Додати розробника",r.textContent="Додати",d.style.display="none";//! 4.1.2 відкриття модального вікна з формою для збирання даних
...
c.textContent="Редагування розробника",r.textContent="Редагувати",d.style.display="block";//! при натисканні на розробника треба, щоб підставлялось його зображення
console.log("event.currentTarget:",e.target.currentTarget),console.log("typyof imgFormDeveloper:",typeof f);//! стратегічна задача (що робимо?)
