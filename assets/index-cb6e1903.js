...
const w=t.compile(r),l=s.map(e=>w(e)).join("");console.log(" markup:",l);f.innerHTML=l;console.log('%c Додаємо/Редагуємо/Видаляємо розробників в секції "Наша команда" ',"color: white; background-color: #D33F49");//! 1.Взяти з localStorage дані які вже у нас є! 
...
document.querySelector(".our-developers-list");documet.querySelector(".our-developers__button");//! 5 Змінні для поточної роботи
//! 6 надати слухачів подій
//! 7 блок функцій
const m=[{name:"Студія",href:"./index.html",active:!0},{name:"Портфоліо",href:"./portfolio.html",active:!1},{name:"Контакти",href:"./contacts.html",active:!1}],b={links:m},g=`{{#each links}}
