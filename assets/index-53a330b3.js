...
const w=i.compile(b),a=o.map(e=>w(e)).join("");console.log(" markup:",a);p.innerHTML=a;console.log('%c Додаємо/Редагуємо/Видаляємо розробників в секції "Наша команда" ',"color: white; background-color: #D33F49");//! 1.1 Взяти з localStorage дані які вже у нас є! 
...
document.querySelector(".our-developers-list");const g=document.querySelector(".our-developers__button"),u=document.querySelector(".form-add-edit-developer__title"),h=document.querySelector("[data-modal-add-edit-developer]"),v=document.querySelector(".modal-add-edit-developer__button-delete"),l=document.querySelector(".form-add-edit-developer");//! 2.2 Змінні для поточної роботи
//! 3 надати слухачів подій
g.addEventListener("click",j);l.addEventListener("submit",x);//! 4 блок функцій 
function j(){console.log("додаємо нового розробника");//! 4.1.1 заміна контенту заголовка модального вікна, приховуємо зайві елементи
u.textContent="Додати розробника",v.style.display="none";//! 4.1.2 відкриття модального вікна з формою для збирання даних
n()}//! відкривання/закривання модального вікна для додавання/редагування розробника
function n(){console.log("відкривання/закривання модального вікна для додавання/редагування розробника"),h.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll")}//! підтвердження даних в формі модальних  вікон ДОДАТИ/РЕДАГУВАТИ 
...
n()}const L=[{name:"Студія",href:"./index.html",active:!0},{name:"Портфоліо",href:"./portfolio.html",active:!1},{name:"Контакти",href:"./contacts.html",active:!1}],U={links:L},R=`{{#each links}}
